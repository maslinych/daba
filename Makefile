...
WINFILES = newmorph.py orthography.py grammar.py formats.py ntgloss.py gparser.pyw mparser.py gdisamb.pyw plugins/*.py metaprint.py wordparser.py dabased.py ad-hoc/daba2vert.py meta.py __init__.py meta.cfg TextCtrlAutoComplete.py
RESOURCES = run/
